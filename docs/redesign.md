...
nothing was lost. It is settled last, at step 67.
...
63. Candidate form — the sidebar, over the endpoints, entities and auth the
    form holds
64. Candidate form — the submit bar, and the collision, cycle and
    nothing-changed checks behind it, answered by Ruby
65. React and Vite removed
66. `/design-preview`, rebuilt from what landed
67. The red request specs — each re-aimed at what landed, and the gaps they
